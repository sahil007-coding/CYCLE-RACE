class Game {
  ...
  async start(){
    ...
    cycle1.shapeColor="green"
    cycle2.shapeColor="yellow"
    cycle3.shapeColor="blue"
    cycle4.shapeColor="pink"
  }
  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      for(var plr in allPlayers){
        ...
        //position the cycles a little away from each other in x direction
        x = x + 200;
        //use data form the database to display the cycles in y direction
